...
$ "Adiabático:" quad macron(delta) Q = 0 quad => quad d U = -macron(delta) W quad => quad C_V thin d T = -P thin d V $

#pagebreak()

$ overline(C)_V (d T)/T = -R (d V)/overline(V) quad => quad T overline(V)^(gamma - 1) = "cte." quad quad gamma equiv overline(C)_P/overline(C)_V $

#pagebreak()

$ P overline(V)^gamma = "cte." quad quad T P^((1 - gamma)/gamma) = "cte." quad quad W = -Delta U = n overline(C)_V (T_1 - T_2) $
